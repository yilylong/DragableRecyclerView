...
import com.zhl.dragablerecyclerview.titanic.Titanic;
import com.zhl.dragablerecyclerview.titanic.TitanicTextView;
import com.zhl.dragablerecyclerview.view.CBRefreshHeaderView;

/**
 * 描述：
 * Created by zhaohl on 2017-8-4.
 */

public class CustomHeader extends CBRefreshHeaderView {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.custom_header, null);
    ...
    public void showHeaderAnim() {
        headrAnimView.setVisibility(VISIBLE);
    ...
    public void stopHeaderAnim() {
        titanic.cancel();
        headrAnimView.setVisibility(GONE);
    }
